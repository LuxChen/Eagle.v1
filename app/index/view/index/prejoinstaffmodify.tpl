  ...
  <div class="staffadd pad5 " style="  ">
    ...
    <div class="staffformInfo fleft">
          ...
          <div  class="formLabi">
            <input name="logon_name" class="inputText" id="logon_name" type="text" disabled  value="{%$staff->itname%}" size="20" maxlength="20"  />
            <input name="username" class="inputText" id="username" type="hidden" value="{%$staff->username%}" size="20" maxlength="20"  readonly="readonly" />
            (英文或数字) </div>
          <div class="h10 clearb"> </div>
          <div  class="formLab">&nbsp;</div>
        ...
        <div  class="formLabi">
         	<input name="mobtel" id="mobtel"  class="inputText" type="text" value="{%$staff->mobtel%}"    size="12" maxlength="12"  />
        </div>
          <div class="formLine clearb " ></div>
          <div  class="formLab">&nbsp;</div>
          <div class="formcontrol">
